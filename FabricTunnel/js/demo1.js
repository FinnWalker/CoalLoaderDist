...
Tunnel.prototype.updateCameraPosition = function () {
  ...
  this.camera.rotation.x = (3 / 360) * (2 * Math.PI);
  this.camera.rotation.y = (182 / 360) * (2 * Math.PI);
  this.camera.rotation.z = (264 / 360) * (2 * Math.PI);
...
Tunnel.prototype.updateMaterialOffset = function (offset) {
  // Update the offset of the material
  this.tubeMaterial.map.offset.x += this.speed * offset;
};
